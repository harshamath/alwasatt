<ul class="breadcrumb">
    ...
    <li><a href="#"><?php echo __('Degrees'); ?></a> <span class="divider"></span></li>
</ul> 
<div class="clr"></div>
<div class="inner_hdng"><h2><?php echo __('Degrees'); ?></h2><?php echo $this->Html->link(__('New Degree'), array('action' => 'add'), array('class' => 'button')); ?></div>
<div class="clr"></div>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($degrees as $degree): ?>
            <tr>
                ...
                <td><?php echo h($degree['Degree']['degree']); ?>&nbsp;</td>
                <td class="actions">
