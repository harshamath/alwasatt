<div class="organizationTypes index">
	...
	<tr>
		...
		<td><?php echo h($organizationType['OrganizationType']['uuid']); ?>&nbsp;</td>
		<td><?php echo h($organizationType['OrganizationType']['name']); ?>&nbsp;</td>
		<td><?php echo h($organizationType['OrganizationType']['slug']); ?>&nbsp;</td>
		<td><?php echo h($organizationType['OrganizationType']['active']); ?>&nbsp;</td>
		<td><?php echo h($organizationType['OrganizationType']['created_by']); ?>&nbsp;</td>
