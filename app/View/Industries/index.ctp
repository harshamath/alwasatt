<ul class="breadcrumb">
    ...
    <li><a href="#"><?php echo __('Industries'); ?></a> <span class="divider"></span></li>
</ul> 
<div class="clr"></div>
<div class="inner_hdng"><h2><?php echo __('Industries'); ?></h2><?php echo $this->Html->link(__('New Industry'), array('action' => 'add'), array('class' => 'button')); ?></div>
<div class="clr"></div>
