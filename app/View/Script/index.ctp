...
function get_company(q) {
	var lnk = "http://www.linkedin.com/ta/company?query="+q;
	
	$.get(lnk, null, function(resp){
...
<?php /*?><div class="awards index">
	...
	<tr>
		...
		<td><?php echo h($award['Award']['user_id']); ?>&nbsp;</td>
		...
		<td><?php echo h($award['Award']['issuer']); ?>&nbsp;</td>
		<td><?php echo h($award['Award']['award_date']); ?>&nbsp;</td>
