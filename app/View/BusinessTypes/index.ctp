<ul class="breadcrumb">
    ...
    <li><a href="#"><?php echo __('Business Types'); ?></a> <span class="divider"></span></li>
</ul> 
<div class="clr"></div>
<div class="inner_hdng"><h2><?php echo __('Business Types'); ?></h2><?php echo $this->Html->link(__('New Business'), array('action' => 'add'), array('class' => 'button')); ?></div>
<div class="clr"></div>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($businessTypes as $businessType): ?>
            <tr>
                ...
                <td><?php echo h($businessType['BusinessType']['active']); ?>&nbsp;</td>
