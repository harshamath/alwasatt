<ul class="breadcrumb">
    ...
    <li><a href="#"></a> <span class="divider"><?php echo __('Edit Business Type'); ?></span></li>
</ul>
<div class="clr"></div>
<div class="inner_hdng"><h2><?php echo __('Edit Business Type'); ?></h2></div>
<div class="clr"></div>
<?php echo $this->Session->flash(); ?>
<div class="advertismnt_banner">
    <div class="lft_section">
        <h2><?php echo __('Edit Business Type'); ?></h2>
        <div class="clr"></div>
    </div>
