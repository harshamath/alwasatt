                    ...
                    <div class="user_prof_wiz_cont1 col-md-12">
                     ...
                     <?php  echo $this->Form->input('patent_office_id',array('options'=>$patentoffices,'class'=>'form-control','between'=>'<div class="col-md-5 pl_0">','after'=>'</div>','div'=>'form-group','label'=>array('class'=>'col-md-4 control-label','text'=>'Patent Office<i class="red_dot">&bull;</i>')),array('escape'=>false));
					   ...
					   ?>
                        ...
                        <div class="col-md-12">
                      <?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>Remove this certificate',array('controller'=>'certifications','action'=>'delete',$this->request->data['Patent']['id']),array('class'=>'pull-left','escape'=>false), __('Are you sure you want to delete # %s?',$this->request->data['Patent']['id'])); ?>
